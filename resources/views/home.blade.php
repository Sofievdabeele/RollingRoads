...
@section('content')
    ...
    <div class="about" >
        ...
        <div class="want">
            <h3>What we want</h3>
            <p>Through our blog and social media channels, our goal is to inspire and empower others to embark on their own van adventuresand discover the joys of slow travel. We want to share our experiences, insights, and tips to help others plan their own journeys and make the most of their van travels.
                ...
                Overall, our blog is a platform for sharing our passion for van travel and encouraging others to join us on this incredible journey.
            </p>
        </div>
    </div>  
@endsection
